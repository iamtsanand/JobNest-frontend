...
const Footer = () => {
  return (
    <footer className="bg-job-darkBlue text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 mb-8">
            ...
            <p className="text-gray-300 mb-4 max-w-xs">
              Connecting talented professionals with their dream careers and helping companies find the perfect match.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Company Reviews</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Salary Calculator</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Career Advice</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Upload Resume</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Browse Candidates</a></li>
        ...
        <div className="pt-8 mt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; 2023 SeekSpark. All rights reserved.
          </p>
